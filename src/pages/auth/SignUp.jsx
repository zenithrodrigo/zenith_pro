        ...
        <div className="w-full">
            ...
            <div className="mt-5">
                <form 
                    ...
                    <div className="relative mt-6">
                        <input type="password" name="password2" id="password2" placeholder="Confirm Password" className="peer peer mt-1 w-full border-b-2 border-gray-300 px-2 py-2 placeholder:text-transparent focus:border-gray-500 focus:outline-none" value={state.password2} onChange={handleChange} required/>
                    </div>
                    <div className="my-6">
                        <button type="submit" className="w-full rounded-md bg-green-500 px-3 py-3 text-white focus:bg-green-400 focus:outline-none">Sign up</button>
                    </div>
                    <p className="text-center text-sm text-gray-500">Do you have an account already?
                        <a href={"/sign-in"}
