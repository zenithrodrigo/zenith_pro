...
const ContactUs = () => {
  ...
  return (
    ...
    //     <h1 className="text-xl font-bold m-8 md:text-3xl">Contact Us</h1>
    //     <p>Have questions? Reach out to us!</p>
    //   </div>
    //   <div className="flex flex-wrap justify-around items-center">
    //     <div className="flex flex-wrap flex-col w-6/12">
    //       <div className="flex flex-col justify-between item-center w-full md:flex-row">
    ...
    //         <h3 className="m-3 text-xl">Send us a Message</h3>
    //         <form className="flex flex-col w-full md:w-9/12 " onSubmit={handleSubmit}>
    ...
    //             <button type="submit" className="flex flex-wrap w-4/12 justify-center bg-white text-green-500 hover:text-blue-400 rounded-lg border-solid border-2 border-green-400 z-0 md:w-2/12">Send</button>
    //           </div>              
    //         </form>
    //       </div>
    //     </div>
    ...
    //       {/* Include your Google Map embed code here */}
    //       <h3 className="m-3 text-xl">View Map</h3>
    //       <iframe
    //         title="Google Map"
            ...
            <div className="mb-12 w-full shrink-0 grow-0 basis-auto md:px-3 lg:mb-0 lg:w-5/12 lg:px-6">
              <form onSubmit={handleSubmit}>
                ...
                <div className="mb-6 inline-block min-h-[1.5rem] justify-center pl-[1.5rem] md:flex">
                  <button type="submit" className="flex flex-wrap w-full justify-center bg-white text-green-500 hover:text-blue-400 rounded-lg border-solid border-2 border-green-400 z-0 md:w-2/12">Send</button>
                </div>                
              </form>
            </div>
                ...
                <div
                  ...
                  <div className="align-start flex">
                    <div className="shrink-0">
                      ...
                      viewBox="0 0 111.756 122.879" enableBackground="new 0 0 111.756 122.879" xml="preserve">
                      <g>
                        <path
                    ...
                    <div className="ml-6 grow">
                      ...
                      <p className="text-neutral-500"> (123) 456-7890
                      </p>
                    </div>
                  </div>
                </div>
